...
namespace Features.Commands
{
    ...
    public class StartSwapCommand
    {
        ...
        public void Execute(Match3Signals.StartSwapSignal startSwapSignal)
        {
            ...
            var firstEntitySwapComponent = new SwappingComponent
            {
                OriginBoardPosition = firstEntityBoardPosition.Position,
                TargetBoardPosition = secondEntityBoardPosition.Position
            };
            var secondEntitySwapComponent = new SwappingComponent
            {
                OriginBoardPosition = secondEntityBoardPosition.Position,
                TargetBoardPosition = firstEntityBoardPosition.Position
            };
