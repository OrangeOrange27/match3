...
namespace Features.Presenters
{
    ...
    public class InputPresenter : MonoBehaviour
    {
        ...
        public void Inject(EntityManager entityManager, SignalBus signalBus, DiContainer diContainer,
            GameStateModel gameStateModel, BoardModel boardModel)
        {
        ...
        private void CheckSwipe(GemView fromGem)
        {
            ...
            Vector2 swipe = new Vector2(touchPosWorld2D.x - fromGem.transform.position.x,
                touchPosWorld2D.y - fromGem.transform.position.y);
        ...
        private void StartSwap(Entity gem1, Entity gem2)
        {
            ...
            if (gem1 != Entity.Null && gem2 != Entity.Null)
            {
                ...
                signalBus.Fire(
                    new Match3Signals.StartSwapSignal(gem1BoardPosition.Position, gem2BoardPosition.Position));
