    ...
    public class EntitiesHelper
    {
        ...
        public static Entity CreateGem(GemColor gemColor, float3 originPosition, int2 boardPosition)
        {
            ...
            EntityManager.SetComponentData(entity,
                new LocalTransform { Position = new float3(originPosition.x, originPosition.y, 0) });
        ...
        public static GemColor GetRandomColor()
        {
            var availableTypes = Enum.GetValues(typeof(GemColor));
            var nextInt = Random.NextInt(availableTypes.Length);
            return (GemColor)nextInt;
        }
    }
}