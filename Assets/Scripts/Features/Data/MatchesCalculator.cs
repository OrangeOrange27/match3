...
namespace Features.Data
{
    ...
    public class MatchesCalculator
    {
        ...
        private void AddVerticalGemsToMatchList(int startX, int startY, int count, int matchIndex,
            Dictionary<int, List<int2>> matchesDict, int[][] matchesMap)
        {
        ...
        private void AddHorizontalGemsToMatchList(int startX, int startY, int count, int matchIndex,
            Dictionary<int, List<int2>> matchesDict, int[][] matchesMap)
        {
            var matchList = matchesDict[matchIndex];
